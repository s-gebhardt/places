...
esgame <- function(req, json_in='{}') {
  geoserver_url <- Sys.getenv("GEOSERVER", "https://esgame-geoserver.containers.wurnet.nl/geoserver/")
...
#### Upload #####
  ...
  created <- gsman$createWorkspace(ws_name, paste0("https://esgame-geoserver.containers.wurnet.nl/geoserver/", ws_name))
